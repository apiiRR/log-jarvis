        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select id="project" @error('project') is-invalid @enderror"
                    class="form-control @error('project') is-invalid @enderror" name="project_id" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="password" id="password-confirm"
                                    placeholder="Repeat Password" class="form-control form-control-user" name="password_confirmation"
