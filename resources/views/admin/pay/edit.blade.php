...
@section('content')
<form method="POST" action="{{ route('pay_slip.update', ['pay_slip' => $pay_data->id]) }}">
    @method('PUT')
    @csrf
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" id="pilih-user" onchange="overtime()" name="pilih-user">
                        ...
                        <option value="{{ $data->id }}" @if ($pay_data->user_id == $data->id)
                            selected
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="user-title" name="user-title" value="{{ $pay_data->title }}">
                </div>
                <div class="form-group col-md-2">
                    <label for="inputZip">Employee ID</label>
                    <input type="text" class="form-control" id="user-id" name="user-id" value="{{ $pay_data->nip }}" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputEmail4">From</label>
                    <input type="date" class="form-control" id="tanggal-awal" name="tanggal-awal" onchange="overtime()" value="{{ $pay_data->from }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputPassword4">To</label>
                    <input type="date" class="form-control" id="tanggal-akhir" name="tanggal-akhir"
                        onchange="overtime()" value="{{ $pay_data->to }}">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="number" class="form-control" id="overtime-total" name="overtime-total"
                            onchange="earning()" readonly value="{{ $pay_data->overtime }}">
                    </div>
                </div>
            </div>
        </div>
